import { DiscordIcon, MediumIcon, TelegramIcon, TwitterIcon } from "../components/SvgIcons";
import { DiscordLink, MediumLink, TelegramLink, TwitterLink } from "./SocialLinks";
...
export interface IDOInterface {
	...
	socialIcons: {icon: any, link: string}[];
}
